...
-- fail test
ex_program1 = Program [Define (Sig "incr" (T.TyArrow [T.TyBase T.TyInteger, T.TyBase T.TyInteger])) (App [(Var "+"), (Var "x"), (Val (Integer 1))])] (App [Var "incr", (Val (Integer 3))])

ex_program1pass = Program [Define (Sig "incr" (T.TyArrow [T.TyBase T.TyInteger, T.TyBase T.TyInteger])) (Lambda [Sig "x" (T.TyBase T.TyInteger)] (App [(Var "+"), (Var "x"), (Val (Integer 1))]))] (App [Var "incr", (Val (Integer 3))])
...
test_evalProgram = do 
    ...
    test "evalProgram single variable globalDefs and simple expression" (evalProgram $ Program 
     [Define (Sig "x" (T.TyBase T.TyInteger)) (Val (Integer 10))] (Var "x"))
     (R.Success (Integer 10))  

    test "evalProgram multiple variable globalDefs and simple expression" (evalProgram $ Program 
     [Define (Sig "x" (T.TyBase T.TyInteger)) (Val (Integer 10)), Define (Sig "y" (T.TyBase T.TyInteger)) (Val (Integer 20))] (App [(Var "+"), (Var "y"), (Var "x")]))
     (R.Success (Integer 30))  

    test "evalProgram multiple of same variable globalDefs and simple expression" (evalProgram $ Program 
     [Define (Sig "x" (T.TyBase T.TyInteger)) (Val (Integer 10)), Define (Sig "x" (T.TyBase T.TyInteger)) (Val (Integer 20))] (App [Var "+", (Var "x"), (Var "x")]))
...
eval g m (App (x:xs)) = do 
    ...
    case v of 
        ...
        where 
            callLambda :: [Signature] -> [Expr] -> Expr -> Env -> Env -> R.Result Value
            ...
            callLambda ((Sig x _):xs) (y:ys) e g m' = do 
                y' <- eval g m y
...
test_eval = do
  ...
  -- // And tests 
    ...
    test "eval lambda: simple 1" (eval empty empty (Lambda [Sig "x" (T.TyBase T.TyInteger)] (Var "x"))) 
     (R.Success (Closure [Sig "x" (T.TyBase T.TyInteger)] (Var "x") empty))

    test "eval lambda: simple 2" (eval empty empty (Lambda [Sig "x" (T.TyBase T.TyInteger), Sig "y" (T.TyBase T.TyInteger)] (Var "x"))) 
     (R.Success (Closure [Sig "x" (T.TyBase T.TyInteger), Sig "y" (T.TyBase T.TyInteger)] (Var "x") empty)) 

    test "eval App: simple 1" (eval empty empty (App [Lambda [Sig "x" (T.TyBase T.TyBoolean)] (Var "x"), Val (Integer 10)])) 
     (R.Success (Integer 10))

    test "eval App: simple 2" (eval empty empty (App [Lambda [Sig "x" (T.TyBase T.TyInteger), Sig "y" (T.TyBase T.TyInteger)] 
     (Var "y"), Val (Integer 10), Val (Integer 15)])) 
     (R.Success (Integer 15)) 

    test "eval App: not enough args 1" (eval empty empty (App [Lambda [Sig "x" (T.TyBase T.TyInteger)] 
     (Var "y")])) 
     (fail "Lambda call did not receive enough arguments.")  

    test "eval App: not enough args 2" (eval empty empty (App [Lambda [Sig "x" (T.TyBase T.TyInteger), Sig "y" (T.TyBase T.TyInteger)] 
     (Var "y"), Val (Integer 10)])) 
     (fail "Lambda call did not receive enough arguments.") 

    test "eval App: too many args" (eval empty empty (App [Lambda [Sig "x" (T.TyBase T.TyInteger)] 
